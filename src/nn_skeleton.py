...
class ModelSkeleton:
  ...
  def __init__(self, mc):
    ...
    assert 'TF_MODE' in mc.keys(), "Please specify mc.TF_MODE as either 'train' or 'eval' "
    if mc.TF_MODE=='train':
        ...
        self.image_input, self.input_mask, self.box_delta_input, self.box_input, self.labels = \
            tf.train.batch(
                tensors=self.FIFOQueue.dequeue(),
